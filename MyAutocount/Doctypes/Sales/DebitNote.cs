...
{
        public class DebitNote : AuthenticatedModule
    {
        ...
        private string Add(dynamic data)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("sales.debitnote", "created", docNo, new { docNo, debtorCode = doc.DebtorCode, docDate = doc.DocDate });
        ...
        private string Edit(dynamic data)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("sales.debitnote", "updated", docNo, new { docNo, debtorCode = doc.DebtorCode });
        ...
        private string Delete(string docNo)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("sales.debitnote", "deleted", docNo);
