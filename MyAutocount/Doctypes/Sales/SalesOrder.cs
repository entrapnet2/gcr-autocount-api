...
{
    public class SalesOrder : AuthenticatedModule
    {
        ...
        private string Add(dynamic data)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("sales.order", "created", docNo, new { docNo, debtorCode = doc.DebtorCode, docDate = doc.DocDate });
        ...
        private string Edit(dynamic data)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("sales.order", "updated", docNo, new { docNo, debtorCode = doc.DebtorCode });
        ...
        private string Delete(string docNo)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("sales.order", "deleted", docNo);
