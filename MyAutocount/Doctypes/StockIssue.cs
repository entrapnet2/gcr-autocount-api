...
{
        public class StockIssue : AuthenticatedModule
    {
        ...
        private string Add(string docNo, string dateString, string description, string refDocNo, List<StockIssueDetailObject> detailObjectsList)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("stock.issue", "created", docNo, new { docNo, description = doc.Description, docDate = doc.DocDate });
        ...
        private string Edit(string docNo, string dateString, string description, string refDocNo, List<StockIssueDetailObject> detailObjectsList)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("stock.issue", "updated", docNo, new { docNo, description = doc.Description });
        ...
        private string Delete(string docNo)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("stock.issue", "deleted", docNo);
