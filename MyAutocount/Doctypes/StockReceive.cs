...
{
        public class StockReceive : AuthenticatedModule
    {
        ...
        private string Add(string docNo, string dateString, string description, string refDocNo, List<StockReceiveDetailObject> detailObjectsList)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("stock.receive", "created", docNo, new { docNo, description = doc.Description, docDate = doc.DocDate });
        ...
        private string Edit(string docNo, string dateString, string description, string refDocNo, List<StockReceiveDetailObject> detailObjectsList)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("stock.receive", "updated", docNo, new { docNo, description = doc.Description });
        ...
        private string Delete(string docNo)
        {
            if (Auth.Login(userSession))
            {
                ...
                PublishEvent("stock.receive", "deleted", docNo);
